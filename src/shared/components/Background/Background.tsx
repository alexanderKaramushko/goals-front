...
export const Background: FC<PropsWithChildren<BackgroundProps>> = ({ children }) => {
  ...
  return (
    ...
    >
      <Box className={styles.svg} component="svg" preserveAspectRatio="none" viewBox="0 0 1440 900">
        <defs>
          <linearGradient
